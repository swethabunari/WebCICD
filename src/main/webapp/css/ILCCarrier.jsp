...
<LINK href="/NCTWeb/theme/nct_report_stylesheet.css" rel="stylesheet"
	type="text/css">
<TITLE>Carrier/Consolidator Ticket Summary</TITLE>
...
<html:form action="/carrierTicketSummary.nct">
	...
	Carrier/Consolidator Ticket Summary </A></H1>
	...
	<table border=0 width=100%>
		<tr>
			...
			<td class="ReportHeaderDataReturn"><bean:write
			...
			<td class="ReportHeaderDataReturn"><bean:write property="partNumber"
				name="ILCCarrierForm" /><html:hidden property="partNumber"
				name="ILCCarrierForm" />&nbsp;<bean:write
		...
		<tr>
			<td class="ReportTagnameReturn">Category:</td>
			<td class="ReportHeaderDataReturn"><bean:write
				property="categoryDescription" name="ILCCarrierForm" /><html:hidden
				property="categoryDescription" name="ILCCarrierForm" /><html:hidden
				property="categoryCode" name="ILCCarrierForm" /></td>
			<td class="ReportTagnameReturn">N/C Status:</td>
			<td class="ReportHeaderDataReturn"><bean:write
	...
	<hr>
	<br>
	<nct:CarrierConsolidatorTicketSummaryDetailDisplay />
	<br>
	...
	<INPUT class="button" TYPE="BUTTON" value="Enter New Search Criteria"
		onclick="window.location='/NCTWeb/core/carrierTicketSummaryEntry.nct';">
